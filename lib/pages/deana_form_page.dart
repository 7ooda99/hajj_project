...
class DeanaFormPage extends StatefulWidget {
  ...
  DeanaFormPage({
    ...
    this.groupNameText,
    this.busNumberText,
    this.totalBagsText, this.userRole,
        ...
        totalBags = TextEditingController(text: totalBagsText),
        super(key: key);
...
class _DeanaFormPageState extends State<DeanaFormPage> {
  ...
  // ── Build notes string including extra groups ──
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Icon(
                            isEditing ? Icons.edit_rounded : Icons.luggage_rounded,
                        ...
                        Text(
                          isEditing ? 'تعديل المجموعة' : 'إضافة مجموعة حقائب',
                          style: const TextStyle(
                            fontFamily: 'Cairo',
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                    ...
                    // Hotel dropdown + count text field row
                    Row(
                      children: [
                        Expanded(
                          flex: 2,
  ...
  Widget _buildExtraGroupCards() {
    ...
    return Column(
      children: [
        _sectionHeader(Icons.luggage_rounded, 'مجموعات الحقائب (${_extraGroups.length})'),
          ...
          return Padding(
            ...
            child: Container(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  '${g['hotel']!.isNotEmpty ? g['hotel'] : 'بدون فندق'}  •  ${g['count']!.isNotEmpty ? '${g['count']} حقيبة' : 'بدون عدد'}',
                  textDirection: ui.TextDirection.rtl,
                  style: TextStyle(
                    fontFamily: 'Cairo',
                    fontSize: 12,
                ...
                leading: Container(
                  ...
                  child: Icon(Icons.luggage_rounded, size: 18, color: kSecondaryColor),
                ),
                trailing: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    InkWell(
                      ...
                      onTap: () => _showAddGroupSheet(editIndex: i),
                      child: Container(
  ...
  Future<void> updateForm() async {
    ...
    final totalBags = widget.totalBags.text;
    var collection =
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            _sectionHeader(Icons.local_taxi, 'بيانات الدينة'),
              ...
              children: [
                Expanded(
                  child: CustomTextField(
                    ...
                    controller: widget.totalBags,
                    onSaved: (data) {
                      formInfo.add({'totalBags': data});
                    },
                    lableText: 'اجمالي الحقائب',
                    maxLines: 1,
